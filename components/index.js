...
export const MENU_ITEM_From = {title: '表单类', before: 'OstInput'};
...
export const MENU_ITEM_Display = {title: '显示类', before: 'OstMask'};
...
export const MENU_ITEM_Other = {title: '样例', before: 'OstDemo'};
